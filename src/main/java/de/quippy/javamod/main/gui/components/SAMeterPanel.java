...
public class SAMeterPanel extends MeterPanelBase {
    ...
    protected void drawMeter(Graphics2D g, int newTop, int newLeft, int newWidth, int newHeight, boolean doClear) {
        switch (drawWhat) {
            default:
            case DRAW_SA_METER:
                drawSAMeter(g, newTop, newLeft, newWidth, newHeight, doClear);
                break;
            case DRAW_WAVE_METER:
                drawWaveMeter(g, newTop, newLeft, newWidth, newHeight, doClear);
                break;
            case DRAW_SK_METER:
                drawSKMeter(g, newTop, newLeft, newWidth, newHeight);
                break;
        }
