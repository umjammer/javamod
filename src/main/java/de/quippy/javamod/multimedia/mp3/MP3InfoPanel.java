...
public class MP3InfoPanel extends JPanel
{
	...
	public void fillInfoPanelWith(Header h, MP3FileID3Controller currentID)
	{
		...
		getmp3Info_Frequency().setText(h.sampleFrequencyString());
		getmp3Info_SampleSizeInBits().setText("16");
		getmp3Info_Channels().setText(h.modeString());
		getmp3Info_Encoding().setText(h.versionString()+" Layer "+h.layerString());
		getmp3Info_BitRate().setText(h.bitrateString());
