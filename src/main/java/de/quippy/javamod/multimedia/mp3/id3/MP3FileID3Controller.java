...
public class MP3FileID3Controller {
     ...
     * @throws ID3v2FormatException if the data of the field is incorrect
     */
     ...
     * @throws ID3v2FormatException if the data of this field is incorrect
     */
     ...
     * @throws ID3v2FormatException if the data of the frame is incorrect
     */
