...
//			modInfo_IsStereo.setEnabled(false); // the FixedStateCheckBox is always disabled
    ...
    public void fillInfoPanelWith(Module currentMod) {
        ...
        if (currentMod == null) {
            ...
            getModInfo_Author().setCaretPosition(0);
            getModInfo_Modname().moveCaretPosition(0);
            ...
            if (currentMod.getPatternContainer() != null)
                getModPatternDialog().fillWithPatternArray(currentMod.getModType(), currentMod.getSongLength(), currentMod.getArrangement(), currentMod.getPatternContainer());
