...
//    public static final double PAL_PAULA_MAX_SAFE_HZ = (PAULA_PAL_CLK / (double) PAL_PAULA_MIN_SAFE_PERIOD);
    ...
    public enum PanBits {Pan4Bit, Pan6Bit, Pan8Bit}
     ...
     */
    public static final int[] FT2_linearPeriods = {
     ...
     * bit-exact to FT2 table from 8bitbubsy's FT2 Clone
     */
    public static final int[] FT2_amigaPeriods = {
...
//    };
     ...
     */
    public static final long HALFTONE_SHIFT = 16;
     ...
     * @return
     */
    public static String getNoteNameForIndex(int index) {
        return switch (index) {
            case NO_NOTE -> "...";    // No Note
            case KEY_OFF -> "===";    // Key Off
            case NOTE_CUT -> "^^^";    // Note cut value
            case NOTE_FADE -> "~~~";    // Note Fade value
            default -> noteStrings[(index - 1) % 12] + (index - 1) / 12;
        };
    }
     ...
     * @return
     */
    public static String getAsHex(long value, int digits) {
        StringBuilder result = new StringBuilder();
        for (int shift = (digits - 1) << 2; shift >= 0; shift -= 4)
...
//    }
    ...
    public static int convertST2tempo(int tempo) {
...
//    }
     ...
     * @return
     */
    public static long promoteSigned8BitToSigned32Bit(long sample) {
        return sample << 24;
    }
...
//    }
     ...
     * @return
     */
    public static long promoteSigned16BitToSigned32Bit(long sample) {
        return sample << 16;
    }
