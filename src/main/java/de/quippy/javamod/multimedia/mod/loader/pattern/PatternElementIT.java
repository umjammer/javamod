                ...
                switch (effectOp >> 4) {
                    ...
                    case 0x7:    // set NNA and others
                        switch (effectOpEx) {
                            ...
                            case 0x1:
                                return "Note Off all NNAs";
                            case 0x2:
                                return "Note Fade all NNAs";
                            case 0x3:
                                return "NNA Cut";
                            case 0x4:
                                return "NNA Continue";
                            ...
                            case 0x6:
                                return "NNA Fade";
                            case 0x7:
                                return "Volume Envelope Off";
                            case 0x8:
                                return "Volume Envelope On";
                            case 0x9:
                                return "Panning Envelope Off";
                            case 0xA:
                                return "Panning Envelope On";
                            case 0xB:
                                return "Pitch Envelope Off";
                            case 0xC:
                                return "Pitch Envelope On";
                        }
                        break;
                    case 0x8:
...
//                                break;
                    ...
                    case 0xF:
                        if ((parentMod.getModType() & ModConstants.MODTYPE_IT) != 0) return "Set Active Macro";
                        else return "Funk Repeat";
                }
                break;
            case 0x14:
                return
